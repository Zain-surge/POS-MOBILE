...
// It returns the final calculated total and the percentage applied.
typedef OnDiscountApplied = Function(double finalTotal, double discountPercentage);
...
class _DiscountPageState extends State<DiscountPage> {
  ...
  Widget _buildDiscountButton(double percentage) {
    bool isSelected = _selectedDiscountPercentage == percentage && !_isCustomDiscountMode && !_showDialerPage;
    return Padding(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      height: 65,
                      child: ElevatedButton(
                        onPressed: _showDialer, // Show dialer instead of navigating
                        style: ElevatedButton.styleFrom(
                          backgroundColor: _showDialerPage ? Colors.grey[300] : Colors.black,
                          foregroundColor: _showDialerPage ? Colors.black : Colors.white,
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(8),
                          ),
                          elevation: 2,
                          side: _showDialerPage ? const BorderSide(color: Colors.grey) : null,
                        ),
                        child: const Row(
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                if (value.isNotEmpty) {
                                  ...
                                  if (customPercentage >= 0 && customPercentage <= 100) {
                                    setState(() {
                                      _selectedDiscountPercentage = customPercentage;
                                      _discountAmount = (widget.subtotal * customPercentage) / 100;
                                      _discountedTotal = widget.subtotal - _discountAmount;
                                    });
                                  }
                                } else {
                        ...
                        child: MouseRegion(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              ...
                              widget.onDiscountApplied(_discountedTotal, _selectedDiscountPercentage);
                              widget.onBack?.call();
                            },
                            child: Container(

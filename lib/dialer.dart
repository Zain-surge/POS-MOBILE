    ...
    setState(() {
      ...
      if (value == '.') {
        ...
        if (!newDisplayValue.contains('.')) {
          newDisplayValue = newDisplayValue == '0' ? '0.' : newDisplayValue + '.';
        }
      } else {
        // Handle number input
      ...
      if (widget.mode == DialerMode.discount) {
        ...
        if (newPercentage > 100.0) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Discount percentage cannot exceed 100%'),
      ...
      child: Padding(
        ...
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            padding: const EdgeInsets.all(18), // Increased padding for larger buttons
          ),
          child: Text(
            value,
      ...
      child: Padding(
        ...
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            foregroundColor: Colors.white,
            shape: const CircleBorder(),
            padding: const EdgeInsets.all(18), // Increased padding for a larger icon
          ),
          child: const Icon(
                ...
                Expanded(
                  child: Material(
                    ...
                    child: InkWell(
                      onTap: () {
                        if (widget.mode == DialerMode.discount) {
                          widget.onDiscountApplied?.call(_discountedTotal, _selectedDiscountPercentage);
                        } else {

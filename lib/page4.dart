...
class _Page4State extends State<Page4> {
  ...
  late String
  _actualOrderType; // <--- ADD THIS LINE: To store the order type for submission
  ...
  void initState() {
    ...
    print(
      "📋 Page4 initialized with ${foodItems.length} food items. Selected Order Type: $_actualOrderType",
    );
  ...
  void _addToCart(CartItem newItem) {
    setState(() {
      int existingIndex = _cartItems.indexWhere((item) {
        ...
        return sameFoodItem &&
            sameOptions &&
            sameComment; // Include comment in comparison
      });
  ...
  double _calculateTotalPrice() {
    ...
    for (var item in _cartItems) {
      double itemPricePerUnit =
          item.foodItem.price.isNotEmpty
          ...
          children: [
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Column(children: [Expanded(child: _buildCartSummary())]),
              ),
            ),
          ],
        ),
        ...
        Expanded(
          child: _cartItems.isEmpty
            ...
            itemBuilder: (context, index) {
              ...
              String sizeDisplay = selectedSize != null
                  ? 'Size: $selectedSize'
                  : 'Size: Default';
              String? crustDisplay = selectedCrust != null
                  ? 'Crust: $selectedCrust'
                  : null;
  ...
  Widget _buildItemGrid() {
    ...
    final filteredItems =
        foodItems
            .where(
              (item) => item.category.toLowerCase() == selectedCategoryName,
            )
            .toList();
          ...
          _navItem(
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder:
                      (context) => const DynamicOrderListScreen(
                        orderType: 'takeaway',
          ...
          _navItem(
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder:
                      (context) => const WebsiteOrdersScreen(

...
class _CustomAmountDialerState extends State<CustomAmountDialer> {
  ...
  double _calculatedDiscountPercentage = 0.0; // This remains internal
  ...
  void _calculateDerivedAmounts() {
    ...
    setState(() {
      _calculatedDiscountPercentage = percentage; // Keep this internal
  ...
  void _onDeletePressed() {
    if (_amountToPayString.isNotEmpty) {
      setState(() {
        _amountToPayString = _amountToPayString.substring(0, _amountToPayString.length - 1);
        if (_amountToPayString.isEmpty) {
  ...
  Widget _buildDialerButton(String text, {VoidCallback? onPressed, IconData? icon}) {
    return Expanded(
      child: AspectRatio(
        aspectRatio: 1,
        child: Padding(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: ElevatedButton(
                                        onPressed:  (_amountToPayString.isNotEmpty && _amountToPay > 0) ? _onConfirmPressed : null,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                            children: [
                                              _buildDialerButton('7', onPressed: () => _onNumberPressed('7')),
                                              _buildDialerButton('8', onPressed: () => _onNumberPressed('8')),
                                              _buildDialerButton('9', onPressed: () => _onNumberPressed('9')),
                                            ],
                                          ),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                            children: [
                                              _buildDialerButton('4', onPressed: () => _onNumberPressed('4')),
                                              _buildDialerButton('5', onPressed: () => _onNumberPressed('5')),
                                              _buildDialerButton('6', onPressed: () => _onNumberPressed('6')),
                                            ],
                                          ),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                            children: [
                                              _buildDialerButton('1', onPressed: () => _onNumberPressed('1')),
                                              _buildDialerButton('2', onPressed: () => _onNumberPressed('2')),
                                              _buildDialerButton('3', onPressed: () => _onNumberPressed('3')),
                                            ],
                                          ),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                            children: [
                                              ...
                                              _buildDialerButton('0', onPressed: () => _onNumberPressed('0')),
                                              _buildDialerButton(
                                                '.',
